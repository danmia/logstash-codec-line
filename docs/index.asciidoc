...
=== LineNull codec plugin

include::{include_path}/plugin_header.asciidoc[]

==== Description

Line-oriented text data that is null terminated.

Decoding behavior: Only whole line events will be emitted.

Encoding behavior: Each event will be emitted with a trailing null.

[id="plugins-{type}s-{plugin}-options"]
==== LineNull Codec Configuration Options
